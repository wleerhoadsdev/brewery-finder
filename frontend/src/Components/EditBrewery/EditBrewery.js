...
export default function EditBrewery(props) {
    ...
    function handleSubmit(event) {
        ...
        console.log(data);
        axios.put(baseUrl + `/brewery/${breweryId}`, data)
            .then(response => {
                alert("Brewery infomation was updated!");
                console.log(response);
            })
            .catch(error => {
                console.log(error.respone.data.error + ': ' + error.response.data.message);
    ...
    return (
        <div className='edit_brewery_page'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="email" placeholder="Brewery Email" name="emailAddress" value={formData.emailAddress} onChange={handleChange} />
                ...
                <input type="text" placeholder="Brewery Home Page Url" name="homePageUrl" value={formData.homePageUrl} onChange={handleChange} />
                <input type="text" placeholder="Brewery Image Url" name = "imageUrl" value={formData.imageUrl} onChange={handleChange} />
